...
export const ContractLayout: FC<Props> = ({ title, children }) => {
        ...
        !user
          ...
          <div>
            ...
            <div style={{ alignItems: 'center', justifyContent: "center", display: "flex", height: '100%' }} >
              ...
              <Box className='fadeIn' sx={{ flexFlow: 1, width: '100%', height: '100%', maxHeight: windowDimensions.width > 1900 ? '100vh' : '77vh' }}>
                {children}
              </Box>
            </div>
          </div>
