...
export const EntityLayout: FC<Props> = ({ title, children }) => {
                ...
                <div>
                  ...
                  <Box >
                    ...
                    <div style={{ alignItems: 'center', justifyContent: "center", display: "flex", height: '100%' }} >
                      ...
                      <Box className='fadeIn' sx={{ flexFlow: 1, width: '100%', maxWidth: windowDimensions.width < 1900 ? (windowDimensions.width < 1400 ? '100%' : '80%') : '90vh', height:"100%" }}>
                        {children}
                      </Box>
                    </div>
